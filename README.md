...
- You can replace the `input_image.png` file with any input you want then refresh the page. It will keep working as long as you keep the cmd window open with the `npx serve` program running.